...
SELECT DEPARTMENT,MAX(SALARY) AS MAX_SALART
FROM EMPLOYEE
GROUP BY DEPARTMENT
...
SELECT CITY,COUNT(*) AS FEMALE_EMPLOYEE
FROM EMPLOYEE
WHERE GENDER = 'FEMALE'
GROUP BY CITY
HAVING COUNT(*) >= 1
...
SELECT DEPARTMENT,MIN(SALARY) AS MIN_MALE_SALARY
FROM EMPLOYEE
WHERE GENDER = 'MALE'
GROUP BY DEPARTMENT
HAVING MIN(SALARY) > 7000
...
SELECT CITY,COUNT(*) AS JOINED_B2023
FROM EMPLOYEE
...
SELECT DEPARTMENT,COUNT(*) AS EMPLOYEE_2022
FROM EMPLOYEE
...
SELECT DEPARTMENT,SUM(SALARY) AS TOTAL_SALARY_FEMALE
FROM EMPLOYEE
WHERE GENDER = 'FEMALE'
GROUP BY DEPARTMENT
HAVING SUM(SALARY) < 15000
...
SELECT CITY,SUM(SALARY) AS TOTAL_SALART_IT
FROM EMPLOYEE
WHERE DEPARTMENT != 'IT'
GROUP BY CITY
HAVING SUM(SALARY) > 15000
...
SELECT DEPARTMENT,AVG(SALARY) AS AVG_SALART_HR
FROM EMPLOYEE
WHERE DEPARTMENT != 'HR'
GROUP BY DEPARTMENT
...
SELECT DEPARTMENT,SUM(SALARY) AS TOTAL_SALARY_MALE
FROM EMPLOYEE 
GROUP BY DEPARTMENT
HAVING SUM(CASE WHEN GENDER = 'MALE' THEN SALARY END) > 
		SUM(CASE WHEN GENDER = 'FEMALE' THEN SALARY END)